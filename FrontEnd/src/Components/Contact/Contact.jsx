    ...
    try {
      ...
      if (response.status === 200) {
        toast.update(toastId, {
          render: "Message submitted succesfully!",
          type: "success",
          autoClose: 2000
        });
      ...
      toast.update(toastId, {
        render: "Message Failed. Try again !.",
        type: "error",
        autoClose: 2000,
      });
    }
      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="bg-gray-900 p-8 rounded-xl shadow-lg border border-gray-700 w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input
              ...
              className="w-full p-3 rounded-lg bg-gray-800 border border-gray-600 focus:ring-2 focus:ring-purple-500 outline-none"
            />
            <input
              type="tel"
              name="mobile"
            ...
            <button
              type="submit"
              className="w-full bg-purple-600 hover:bg-purple-700 transition-all py-3 rounded-lg font-semibold text-lg"
            >
              Send Message
            </button>
          </form>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4 bg-gray-900 p-5 rounded-lg shadow-md">
            📧 <p className="text-lg">i.m.bhabani.00@gmail.com</p>
          </div>
          <div className="flex items-center space-x-4 bg-gray-900 p-5 rounded-lg shadow-md">
            📞 <p className="text-lg">+9827875064</p>
          </div>
        </div>
      </div>
    </section>
